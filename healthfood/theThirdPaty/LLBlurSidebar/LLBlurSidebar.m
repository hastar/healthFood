...
- (void)viewDidLoad {
    ...
    self.snapImageView = [[[UIImageView alloc] initWithFrame:self.view.bounds] autorelease];
...
- (void)setBlurViewAlpha
{
    ...
    self.blurView.alpha = percent = 0.2 + (0.3-0.2)*(percent); // 不从0开始，效果更明显
